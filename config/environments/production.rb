Rails.application.configure do
  ...
  # VitalMarcheache or NGINX already handles this.
  ...
  # Disable Rails's static asset server (VitalMarcheache or nginx will already do this)
  ...
  # config.action_dispatch.x_sendfile_header = 'X-Sendfile' # for VitalMarcheache
